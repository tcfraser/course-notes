...
\end{pmatrix} \]
Notice that,
\[ \bs{R_{x}\br{\ep}, R_{y}\br{\ep}} = R_{x}\br{\ep^2} - \mathbb{I} \]
\subsection{Rotations in Quantum Mechanics}
Let the rotation be some operator $D \in \s{B}\br{\s{H}}$ be,
...
\[ D\br{\hat n, \dif \varphi} = \mathbb{I} - \f{i}{\hbar} \ve J \cdot \hat n \dif \varphi \]
...
\[D\br{\hat n, \varphi} = \lim_{N \to \inf} \bs{\mathbb{I} - \f{i}{\hbar} \ve J \cdot \hat n \f{\varphi}{N}}^N \]
Which gives the familiar result,
\[D\br{\hat n, \varphi} = e^{-\f{i}{\hbar} \ve J \cdot \hat n \varphi} \]
