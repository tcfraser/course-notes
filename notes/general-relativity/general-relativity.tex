...
If there are two identical indices, 1 ``up'' and 1 ``down'', it means that a summation is secretly present, it's just be removed for convience. Note that the $i$ in this case is \textit{dummy index}.
...
What does performing \textit{well} mean? A tensor is performing well if its components transform as
...
\begin{tikzpicture}[scale=1.0]
    % Draw axes
    \coordinate (negyaxis) at (0, -1);
    \coordinate (posyaxis) at (0, 3);
    \coordinate (negxaxis) at (-2, 0);
    \coordinate (posxaxis) at (4, 0);
    \draw [<->, thick] (negyaxis) -- (posyaxis);
    \draw [<->, thick] (negxaxis) -- (posxaxis);
    \node [above] (labyaxis) at (posyaxis) {$t$};
    \node [right] (labxaxis) at (posxaxis) {$x$};
    \draw [orange, thick, ->] plot [smooth, tension=1] coordinates {(negyaxis) (posyaxis)};
    \node [orange] (label) at (-0.5, 0.5) {$x(t)$};
    \draw [red, thick, ->] plot [smooth, tension=1] coordinates {($(negyaxis) + (1,0)$) ($(posyaxis) + (1,0)$)};
...
\begin{tikzpicture}[scale=1.0]
    ...
    \node [above] (labyaxis) at (posyaxis) {$t$};
    \node [right] (labxaxis) at (posxaxis) {$x$};
    \draw [red, thick, ->] plot [smooth, tension=1] coordinates {(negyaxis) (posyaxis)};
    \node [red, left] (label) at (posyaxis) {$A$};
    \draw [blue, thick, ->] plot [smooth, tension=1] coordinates {(-0.5, -1) (1.5, 3.0)};
...
\begin{tikzpicture}[scale=1.0]
    ...
    \node [above] (labyaxis) at (posyaxis) {$t$};
    \node [right] (labxaxis) at (posxaxis) {$x$};
    \draw [red, thick] plot [smooth, tension=1] coordinates {(1,1.5) (3,1.5)};
    \node [red, left, circle] (label) at (1,1.5) {$x_A$};
    \node [red, right, circle] (label) at (3,1.5) {$x_B$};
\end{tikzpicture}
\end{center}
...
\begin{itemize}
    \item Maxwell's equations do not transform well under Galilean transforms. Lorrentz found the Lorrentz transformations that allow Maxwell's equations to transform well.
...
\subsection{Lorrentz Transformations}
...
\begin{tikzpicture}[scale=1.0]
    ...
    \draw [<->, thick] (negyaxis) -- (posyaxis);
    \draw [<->, thick] (negxaxis) -- (posxaxis);
    \draw [->, thick, red] (negyaxis) -- (posyaxis);
    \draw [->, thick, blue] (-0.5, -1) -- (1.5,3);
    \draw [->, thick, yellow] (0, 0.5) -- (ed) -- (posyaxis);
    \node [left, red] (alicelabel) at (posyaxis) {Alice};
...
\begin{tikzpicture}[scale=1.0]
    ...
    \draw [->, thick, red] (negyaxis) -- (posyaxis);
    \draw [->, thick, blue] (-0.5, -1) -- (1.5,3);
    \node [left, red] (alicelabel) at (posyaxis) {A};
...
\begin{tikzpicture}[scale=1.0]
    ...
    \fill (xt) circle[radius=1pt];
    \draw [->, thick, yellow] (t1) -- (xt) -- (t2);
    \draw [->, thick, yellow] ($(t1) + (0, 0.25)$) -- ($(xt) + (0.25, 0.50) $);
    \draw [<->, thick] (negyaxis) -- (posyaxis);
    \draw [<->, thick] (negxaxis) -- (posxaxis);
    \draw [->, thick, red] (negyaxis) -- (posyaxis);
    \draw [->, thick, blue] (-0.5, -1) -- (1.5,3);
...
\TODO{This pic is broken}

\[ \Delta t_A = f(v, c, x_0, y_0) \Delta t_B \]

By translational invariance, $f$ cannot depend on $x_0$ or $t_0$. Therefore,

\[ \Delta t_A = f(v, c) \Delta t_B \]
