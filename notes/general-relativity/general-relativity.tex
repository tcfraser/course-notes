...
\[ V^\al = \br{V^0, 0, 0, 0} \]
Since in the rest frame of the observer, the observer is a geodesic, we have the normalization condition, $V^\al g_{\al\be} V^\be = -1$.
\[ V^0 = \pm \br{1 - \f{R_s}{r}}^{-1/2} \]
