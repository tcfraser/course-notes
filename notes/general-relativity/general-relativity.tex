...
All of these together form the Poincare group.
...
\[ \vec{v_1 \oplus v_2} = \f{1}{1+\f{\vec{v}_1\cdot\vec{v}_2}{c^2}}\br{\vec{v}_1 + \f{1}{\ga_1}\vec{v}_2 + \f{1}{c}\f{\ga_1}{1-\ga_1}\br{\vec{v}_1\cdot\vec{v}_2} \vec{v}_2}\]

Note these aren't associative,

\[ \vec{\vec{v_1 \oplus v_2} \oplus \vec{v}_3} \neq \vec{v_1 \oplus \vec{v_2 \oplus \vec{v}_3}} \]

However it $\vec{v}_1$ is parallel to $\vec{v}_2$ then,

\[ \vec{v_1 \oplus v_2} = \f{\vec{v}_1 + \vec{v}_2}{1 + \f{\vec{v}_1 \cdot \vec{v}_2}{c^2}} \]

Which forces $\abs{\vec{v_1 \oplus v_2}}^2 = c^2$ whenever either $\vec{v}_1$ or $\vec{v}_2$ has $\abs{\vec{v}_i}^2 = c^2$.
