...
In order to compute red shift it is convenient to utilize \textbf{killing vectors}. Since the Schwarzschild metric does not depend on time,
\[ \di_t g_{\al\be} = 0 \]
...
Here $a\br{t}$ is known as a \textbf{scale factor}. Moreover the square on $a\br{t}$ is introduced to ensure positiveness. Combining all of these motivations together yields the \textbf{Friedmann Le maître Robertson Walker metric (FLRW).}
...
These equation we first obtained by Friedmann in 1922 and later by Le maître 1927. Even without solving these equations we can learn a lot by making astronomical observations. We can learn about,
\begin{enumerate}
...
Which becomes,
\[ \dot{a}^2 = \f{c_M}{a} + \f{c_R}{a^2} - k + \f{\Lambda}{3}a^2 \]
...
\[ \text{radiation} \ar \text{matter} \ar \text{curvature} \ar \text{cosmological constant} \]
% TODO einstein universe
\subsection{Einstein Universe}
\TODO{Einstein Universe Here}
\section{Gravitational Waves}
\TODO{Gravity waves slides here}
