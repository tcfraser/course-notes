...
\begin{enumerate}
    ...
    \begin{center}
        ...
        \draw[->] (0,0) -- (0,0,2)node[below left]{$z$};
        \foreach \x in {1,2}
        \foreach \y in {1,2}
        \foreach \z in {1,2}
        \draw[] (\x,\y,\z) node[fill=black, circle, inner sep=1pt]{};
        \draw[] (1,1,1) -- (2,1,1) node[right]{$\ve a_1$};
        \draw[] (1,1,1) -- (1,2,1) node[above]{$\ve a_2$};
        \draw[] (1,1,1) -- (1,1,2) node[below left]{$\ve a_3$};
        \foreach \xa in {1,2}
        \foreach \ya in {1,2}
        \foreach \za in {1,2}
        \foreach \xb in {1,2}
        \foreach \yb in {1,2}
        \foreach \zb in {1,2}
        \draw[gray, very thin, dashed] (\xa, \ya, \za) -- (\xb, \yb, \zb);
