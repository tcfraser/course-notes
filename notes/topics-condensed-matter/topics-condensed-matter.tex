...
\end{align*}
Here $S$ is the surface of the sample. It is possible to neglect the surface term since it only determines the boundary conditions for $\vp$ in a finite sample. Therefore \cref{eq:glfe_variation} becomes,
\begin{align*}
    \de_{\vp^*} F
...
\begin{align*}
    ...
    &\qquad= \f{1}{4\pi}\int \dif \ve r \de \ve A \cdot \vdel \times\br{\vdel \times \ve A} - \f{1}{4\pi} \oint \dif \ve S \cdot \bs{\de \ve A \times \br{\vdel \times \ve A - \ve H}}
\end{align*}
The surface integral vanishes because since the magnetic field at the surface of the conductor is fixed by boundary conditions. Thus $\de A|_{S} = \ve 0$. Thus we obtain,
\begin{align*}
...
\begin{center}
    \begin{tikzpicture}[scale=2]
        ...
        \draw[thick] (0.7,1.0) node[]{Vortex};
