...
\[  f\br{\ve M} = a \ve M \cdot \ve M + \f{b}{2} \br{\ve M \cdot \ve M}^2 + \cdots\]
...
In the case where $T > T_c$, we have,
\[ \chi = \f{1}{2a} = \f{1}{2a_1t} \]
