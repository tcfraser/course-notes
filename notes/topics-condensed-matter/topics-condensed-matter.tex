...
\[ \f{1}{N} \sum_{n=1}^{N} e^{i\br{k - k'}na} = \f{1}{N} \sum_{n=1}^{N} e^{i2 \pi \mu n / N} = \de_{\mu} = \de_{k, k'} \]
...
In the limit of the $\de t \to 0$ one should expect to recover \cref{eq:toy_single_energy_band},
