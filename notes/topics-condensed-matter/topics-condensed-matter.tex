...
\[ \ve a_1 = \f{a}{2} \br{\hat x + \sqrt{2} \hat y} \]
\[ \ve a_2 = \f{a}{2} \br{-\hat x + \sqrt{2} \hat y} \]
...
\todo[TC]{Draw Graphene lattice}
\begin{center}
\begin{tikzpicture}
    \pgfmathsetmacro{\size}{3};
    \pgfmathsetmacro{\f}{1/sqrt(3)};
    \pgfmathsetmacro{\ss}{sqrt(2)};
    \draw (0,0) node[circle, inner sep=1pt, fill=black, label={above right:$1$}]{};
    \draw (0,\size) node[circle, inner sep=1pt, fill=black, label={above right:$2$}]{};
    \draw (\f*\size,-\ss*\f*\size) node[circle, inner sep=1pt, fill=black, label={above right:$2$}]{};
    \draw (-\f*\size,-\ss*\f*\size) node[circle, inner sep=1pt, fill=black, label={above right:$2$}]{};
\end{tikzpicture}
\end{center}
...
\[ H = -t \sum_{\ve R} \br{\ket{\ve R, 2} \bra{\ve R, 1} + \ket{\ve R - \ve a_{1}m 2}\bra{\ve R, 1} + \ket{\ve R - \ve a_2, 2}\bra{\ve R, 1} + \text{h.c.}} \]
