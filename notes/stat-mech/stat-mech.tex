...
\TODO{Draw a standard carnot curve on PV plot}
...
\TODO{Insert PV circle liney diagram}
...
\draw [blue, thick, ->] plot [smooth, tension=1] coordinates { (1) (A) (2)};
\draw [blue, thick, ->] plot [smooth, tension=1] coordinates { (2) (B) (1)};
...
\coordinate (A) at (0.8,1.2);
\coordinate (B) at (1.2,0.8);
\draw [red, thick, ->] plot [smooth, tension=1] coordinates { (1) (A) (2)};
\draw [blue, thick, ->] plot [smooth, tension=1] coordinates { (2) (B) (1)};
...
\begin{enumerate}
    ...
    \begin{itemize}
        \item Consider two regions of a container separated by a diathermal wall
