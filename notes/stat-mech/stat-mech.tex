...
Each of these $k$ tracks the location of the representative point over time. We need an object/quantity that gives us a measure of the distribution representative points.
\[ \rho \br{\underbrace{p(t), q(t)}_{6N \text{ variables}}; t} \]

For example, $\rho \dif V = \dif Q$. Consider this quantity,
