...
\begin{center}
    \includegraphics[scale=0.3]{figures/temp_dan.jpg}
\end{center}
\vspace{-0.3in}
\begin{center}
    \footnotesize Many thanks to Dan Southall\\
    \footnotesize for this excellent diagram.
\end{center}
...
Where $\vv$ is a velocity of the rate of displacement of representative points. This is a flux of representative points through the surface of the solution shell. The conservation implies that \eqref{eq:rpflux} balances \eqref{eq:reflow}.
...
Which by the Reymond-Dubois Lemma gives,
