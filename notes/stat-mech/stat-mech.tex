...
Superfluid $^4\text{He}$ has $T_c \sim \SI{2.17}{\K}$ is a complex form of a BEC. Also $^3\text{He}$ (a fermion) is also a superfluid with $T \sim \SI{1}{\micro \K}$. This is achieved when two fermions form a \textbf{Cooper pair} to form a composite boson that can then be thought of as a BEC. Superconductivity is a form of a BEC.
\end{document}
