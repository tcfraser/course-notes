...
But we have that $\vdel \cdot \ve E = \f{1}{\ep} \rho_{f}$. In a conductor $\rho_{f} \approx 0$ because the time scale to equilibriate which is $\tau_{d} = \f{\ep}{\si} \approx \SI{1e-20}{\s}$ (of course if your frequency is $f \geq \tau_d^{-1}$ this approximation doesn't hold).
