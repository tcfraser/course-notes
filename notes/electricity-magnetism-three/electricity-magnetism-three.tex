...
Which in vector notation is much simplier \todo[TC]{Verify this expression},
...
So far, we have only considered 1D waves. However, the electric and magnetic fields are vector quantities. Consider the vector amplitude,
\[ \ti {\ve f}\br{z, t} = \ti f_{k} \hat n e^{i\br{kz - \w t}} \]
Where $e^{i\br{kz - \w t}}$ acts as the traveling wave, $\hat n$ is the polarization and $\ti f_{k}$ is the amplitude and phase.
